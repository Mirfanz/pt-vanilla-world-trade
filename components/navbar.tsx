  ...
  return (
    <nav
      className={clsx(
        ...
        path == "/" ? "absolute left-0 right-0 top-0 bg-transparent" : "sticky top-0"
      )}
    >
      <div className="container">
        <div className="flex items-center py-4 gap-6">
          <div className="flex items-center gap-2">
            <Image alt="logo" className="w-10 h-10 rounded" height={512} src={"/logo-transparent.png"} width={512} />
          ...
          <div className="">
            ...
            <Button isIconOnly className="md:hidden inline-flex" color="primary" size="md">
              X
            </Button>
          </div>
        </div>
